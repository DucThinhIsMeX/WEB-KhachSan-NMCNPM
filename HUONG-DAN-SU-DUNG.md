...
**Xóa phòng:**
- Click nút **🗑️ Xóa** ở cột Thao Tác
...
3. Chọn **🛏️ Phòng** (chỉ hiện phòng trống)
...
Menu **🔧 Dev Tools** cung cấp:
- **🔄 Tạo Dữ Liệu Mẫu**: Tạo 6 phòng để test
- **👁️ Xem Dữ Liệu**: Xuất LocalStorage ra Console
- **🗑️ Xóa Tất Cả Dữ Liệu**: Reset hệ thống
