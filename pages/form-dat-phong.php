    ...
    <div class="booking-container">
        <header class="booking-header">
            <div class="header-content">
                <h1><i class="ph ph-sparkle"></i> Đặt Phòng Trực Tuyến</h1>
                <p>Hoàn tất thông tin để đặt phòng</p>
            </div>
            <nav class="booking-nav">
                <a href="../index.php"><i class="ph ph-house"></i> Trang chủ</a>
                <a href="tra-cuu-dat-phong.php"><i class="ph ph-magnifying-glass"></i> Tra cứu đặt phòng</a>
            </nav>
        </header>
        ...
        <main class="booking-main">
            ...
            <div class="success-message">
                <h2><i class="ph ph-check-circle"></i> Đặt Phòng Thành Công!</h2>
                <p>Cảm ơn bạn đã đặt phòng tại khách sạn của chúng tôi.</p>
                <div class="booking-code"><i class="ph ph-ticket"></i> Mã Phiếu Thuê: #<?= $maPhieuThue ?></div>
                <p><strong>Vui lòng lưu lại mã này để tra cứu và check-in.</strong></p>
                
                <div style="margin-top: 30px;">
                    <p><i class="ph ph-calendar"></i> Ngày nhận phòng: <strong><?= date('d/m/Y', strtotime($_POST['ngayBatDau'])) ?></strong></p>
                    <p><i class="ph ph-bed"></i> Phòng: <strong><?= $phong['SoPhong'] ?> - <?= $phong['TenLoai'] ?></strong></p>
                    <p><i class="ph ph-currency-circle-dollar"></i> Đơn giá: <strong><?= number_format($phong['DonGiaCoBan']) ?>đ/đêm</strong></p>
                </div>

                <div style="margin-top: 30px;">
                    <a href="../index.php" class="btn" style="background: white; color: #667eea; margin-right: 10px;">
                        <i class="ph ph-arrow-left"></i> Về trang chủ
                    </a>
                    <a href="tra-cuu-dat-phong.php?keyword=<?= $maPhieuThue ?>&search=1" class="btn">
                        <i class="ph ph-magnifying-glass"></i> Xem chi tiết đặt phòng
                    </a>
                </div>
            </div>
            <?php else: ?>
            ...
            <div class="room-summary">
                <h2><i class="ph ph-buildings"></i> Thông Tin Phòng Đã Chọn</h2>
                <div class="info-grid">
                    <div class="info-item">
                        <span>Số Phòng</span>
                ...
                <div style="margin-top: 20px;">
                    <div class="estimate-box" role="status" aria-live="polite">
                        <div><i class="ph ph-diamond"></i> Giá ước tính:</div>
                        <div class="estimate-value" id="estimateValue"><?= number_format($phong['DonGiaCoBan']) ?>đ</div>
                    </div>
                </div>
                <?php if ($phong['GhiChu']): ?>
                <p style="margin-top: 15px; font-style: italic;"><i class="ph ph-note-pencil"></i> <?= $phong['GhiChu'] ?></p>
                <?php endif; ?>
            </div>

            <!-- Form đặt phòng -->
            <div class="booking-form">
                <h2><i class="ph ph-list-bullets"></i> Thông Tin Đặt Phòng</h2>
                
                <form method="POST" id="formDatPhong">
                    <input type="hidden" name="maPhong" value="<?= $phong['MaPhong'] ?>">
                    
                    <div class="form-group">
                        <label class="required-label"><i class="ph ph-calendar"></i> Ngày Nhận Phòng:</label>
                        <input type="date" name="ngayBatDau" 
                               value="<?= date('Y-m-d') ?>" 
                               min="<?= date('Y-m-d') ?>"
                               required>
                        <small><i class="ph ph-clock"></i> Giờ nhận phòng: 14:00. Giờ trả phòng: 12:00</small>
                    </div>

                    <hr style="margin: 30px 0;">

                    <h2><i class="ph ph-users"></i> Thông Tin Khách Hàng</h2>
                    ...
                    <div class="khach-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="loaiKhach1" required>
                                    <option value="Nội địa"><i class="ph ph-flag"></i> Nội địa</option>
                                    <option value="Nước ngoài"><i class="ph ph-globe"></i> Nước ngoài (Hệ số ×<?= $database->getThamSo('HS_KHACH_NUOC_NGOAI') ?>)</option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="required-label"><i class="ph ph-map-pin"></i> Địa Chỉ:</label>
                    ...
                    <div class="form-group">
                        <label>
                            ...
                            <i class="ph ph-check-circle"></i> Tôi đã đọc và đồng ý với <a href="#" style="color: #667eea;">điều khoản sử dụng</a>
                        </label>
                    </div>
                    ...
                    <div style="display: flex; gap: 15px; margin-top: 30px;">
                        ...
                        <button type="submit" class="btn" style="flex: 2;">
                            <i class="ph ph-check-circle"></i> Xác Nhận Đặt Phòng
                        </button>
                    </div>
                </form>
            </div>
        ...
        <footer class="booking-footer">
            <p>© 2024 Khách sạn - Hệ thống đặt phòng trực tuyến</p>
        </footer>
    </div>
